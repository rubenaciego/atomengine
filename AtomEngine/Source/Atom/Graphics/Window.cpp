...
namespace Atom
{
	...
	Window::Window(const std::string& title, int width, int height)
	{
		...
		Debug::Log("[Atom]: Creating the window...\n");
	...
	void Window::SetTitle(const std::string& title)
	{
		...
		Debug::Log("[Atom]: Window title set: " + title + "\n");
	}
	...
	bool Window::Init()
	{
		...
		Debug::Log("[Atom]: GLFW initialized\n");
		...
		{
			glfwTerminate();
			Debug::Error("[Atom]: Failed to create the window!\n");
			return false;
		}

		Debug::Log("[Atom]: Window created\n");
		...
		if (glewInit() != GLEW_OK)
		{
			Debug::Error("[OpenGL]: Failed to initialize GLEW\n");
			return false;
		}

		Debug::Log("[Atom]: GLEW initialized, using the OpenGL Rendering API\n");
		Debug::Log("[OpenGL]: OpenGL Version: " + std::string((const char*)glGetString(GL_VERSION)) + '\n');
	...
	void WindowResize(GLFWwindow* window, int width, int height)
	{
		...
		Debug::Log("[Atom]: Window resized: " + std::to_string(width) + ", " + std::to_string(height) + "\n");
	}
