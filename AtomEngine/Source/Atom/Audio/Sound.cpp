...
namespace Atom
{
	...
	void Sound::Play()
	{
		...
		m_Handle = gau_create_handle_sound(AudioManager::mixer, m_Sound,
		...
		Debug::Log("[Atom]: Playing sound " + m_Name + "\n");
	}
	...
	void Sound::Loop()
	{
		...
		Debug::Log("[Atom]: Playing sound " + m_Name + " in loop\n");
	}
	...
	void Sound::Resume()
	{
		...
		Debug::Log("[Atom]: Resumed sound " + m_Name + "\n");
	}
	...
	void Sound::Pause()
	{
		...
		Debug::Log("[Atom]: Paused sound " + m_Name + "\n");
	}
	...
	void Sound::Stop()
	{
		...
		Debug::Log("[Atom]: Stopped sound " + m_Name + "\n");
	}
	...
	void Sound::SetGain(float gain)
	{
		if (!m_Playing)
		{
			Debug::Error("[Atom]: Cannot set the audio gain of" + m_Name + "if it's not playing!\n");
			return;
		}
